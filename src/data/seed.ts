...
export const breakPolicies: BreakPolicy[] = [
  {
    id: 'bp1',
    type: 'break',
    name: 'Standard outdoor',
    description: 'Default unpaid lunch for field crews. Auto-mandates a paid break during the heat ban window.',
    paid: 'unpaid',
  ...
  },
  {
    ...
    type: 'break',
    name: 'Office flex',
    description: 'Flexible lunch window for office-based salaried staff.',
    paid: 'unpaid',
    countTowardWorkHours: false,
    defaultScheduleType: 'flexible',
    autoMandatePaidDuringHeatBan: false,
    forceBreakAfter5h: true,
    appliesTo: { groupIds: ['g2', 'g4'], employeeCount: 132 },
  },
  {
    id: 'bp3',
    type: 'break',
    name: 'Manufacturing hybrid',
    description: 'Mixed paid/unpaid breaks across morning, lunch, and afternoon.',
    paid: 'mixed',
    countTowardWorkHours: false,
    defaultScheduleType: 'mixed',
    autoMandatePaidDuringHeatBan: true,
    forceBreakAfter5h: true,
    appliesTo: { groupIds: ['g3'], employeeCount: 32 },
  },
];

export const clockWindowPolicies: ClockWindowPolicy[] = [
  {
    id: 'cw1',
    type: 'clock_window',
    name: 'Field worker strict',
    description: 'Tight grace and required GPS/geofence for field-based crews.',
    ...
    ipRestricted: false,
    appliesTo: { groupIds: ['g1', 'g3'], employeeCount: 56 },
  },
  {
    id: 'cw2',
    type: 'clock_window',
    name: 'Office standard',
    description: 'Generous grace, no geofence — fits salaried office staff.',
